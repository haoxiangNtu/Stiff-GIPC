#!/usr/bin/env python3
"""Ridgeback Dual Panda + Shirt free-fall (semi-implicit) — Case 27-S1-HYBRID (mobile, gripper lite, others real high-poly).
...
def main():
    ...
    def callback():
        ...
        if _begin_window("Ridgeback Panda + Shirt Free-Fall (Case 27-S1-HYBRID (mobile, gripper lite, others real high-poly))"):
            if running[0]:
