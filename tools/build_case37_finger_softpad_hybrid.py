...
SOFTPAD = REPO / "Assets/sim_data/tetmesh/softgriper_part3.msh"
OUT_UNIFIED = REPO / "Assets/sim_data/hybrid_d/CASE37_unified.npz"
OUT_RIGID   = REPO / "Assets/sim_data/hybrid_d/CASE37_rigid.msh"
OUT_REMAP   = REPO / "Assets/sim_data/hybrid_d/CASE37_rigid_remap.npz"
...
def main():
    ...
    out = tet.tetrahedralize(
        ...
        fixedvolume=True, maxvolume=1.5e-6,
    )
