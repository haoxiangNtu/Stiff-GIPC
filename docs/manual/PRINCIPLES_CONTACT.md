...
4. [摩擦](#4-摩擦)
   - 4.1 滞后摩擦模型 · 4.2 λ 的数学 · 4.3 光滑化 f0/f1/f2 与 fricDHat/eps · 4.4 三处分支阈值的一致性 · 4.5 buildFrictionSets · 4.6 per-body μ
5. [摩擦保真实测](#5-摩擦保真实测)
6. [地面接触](#6-地面接触)
...
(稳定线曾在 v0.8.5.4 引入 `absolute_epsv` 覆盖旋钮,但 **v0.8.5.3 与 phase-cd 均为场景派生 epsv**,本册不涉及 v0.8.5.4。)
