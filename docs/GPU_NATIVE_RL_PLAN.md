...
| Batched heterogeneous environments | Merged batching done; isolated overlays open | Merged multi-env is the standard batching form and works through the ABI (point_to_group / env_quarantined / env_count handles). Isolated/strict overlays remain honestly rejected by eligibility. |
