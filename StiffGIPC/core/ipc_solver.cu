...
extern __global__ void _global_ls_decide(const double* energy0, const double* energy1, double c1m, double alpha, double energy_abs_tol, double energy_rel_tol, int* status, const int* gd_collapse, const double* alpha_dev, const double* c1m_dev);
extern __global__ void _ls_trial_begin(double* alpha_dev, int* status);
extern __global__ void _ls_seed(double* alpha_dev, double alpha0, int* status, double* scal2, double c1m, double kappa);
