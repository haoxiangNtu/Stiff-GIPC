...
#include "contact/barrier_rank.h"  // [E3.5] RANK hoisted (single source)
#define NEWF
...
#include "energy/energy_terms.h"          // energy-term table (doc-only, E1a)

#include "device_common/matrix_pd.cuh"  // [E3.5] hoisted for term TUs
...
#include "device_common/triplet_write.cuh"  // [E3.2] hoisted for term TUs
