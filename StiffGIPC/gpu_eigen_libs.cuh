...
__device__ __host__ void __M_Mat_multiply(const Matrix3x3d& A,
                                          const Matrix3x3d& B,
                                          Matrix3x3d&       output);

__device__ __host__ Matrix3x3d __M_Mat_multiply(const Matrix3x3d& A, const Matrix3x3d& B);

__device__ __host__ Matrix2x2d __M2x2_Mat2x2_multiply(const Matrix2x2d& A,
                                                      const Matrix2x2d& B);
...
__device__ __host__ Matrix9x6d __M9x6_M6x6_Multiply(const Matrix9x6d& A,
                                                    const Matrix6x6d& B);

__device__ __host__ Matrix6x3d __M6x3_M3x3_Multiply(const Matrix6x3d& A,
                                                    const Matrix3x3d& B);

__device__ __host__ Matrix3x2d __M3x2_M2x2_Multiply(const Matrix3x2d& A,
                                                    const Matrix2x2d& B);
...
__device__ __host__ Matrix9x2d __M9x2_M2x2_Multiply(const Matrix9x2d& A,
                                                    const Matrix2x2d& B);

__device__ __host__ Matrix6x2d __M6x2_M2x2_Multiply(const Matrix6x2d& A,
                                                    const Matrix2x2d& B);

__device__ __host__ Matrix12x12d __M12x2_M12x2T_Multiply(const Matrix12x2d& A,
                                                         const Matrix12x2d& B);

__device__ __host__ Matrix9x9d __M9x2_M9x2T_Multiply(const Matrix9x2d& A,
                                                     const Matrix9x2d& B);

__device__ __host__ Matrix6x6d __M6x2_M6x2T_Multiply(const Matrix6x2d& A,
                                                     const Matrix6x2d& B);

__device__ __host__ Matrix12x12d __M12x6_M6x12_Multiply(const Matrix12x6d& A,
                                                        const Matrix6x12d& B);

__device__ __host__ Matrix9x9d __M9x6_M6x9_Multiply(const Matrix9x6d& A,
                                                    const Matrix6x9d& B);

__device__ __host__ Matrix6x6d __M6x3_M3x6_Multiply(const Matrix6x3d& A,
                                                    const Matrix3x6d& B);
...
__device__ __host__ double __f(const double& x,
                               const double& a,
                               const double& b,
                               const double& c,
                               const double& d);
