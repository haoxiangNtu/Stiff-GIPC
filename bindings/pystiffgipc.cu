...
PYBIND11_MODULE(pystiffgipc, m)
{
    ...
    py::class_<frame_fsm::FrameStatus>(m, "FrameStatus")
        ...
        .def_readonly("err_newton_iter", &frame_fsm::FrameStatus::err_newton_iter)
        ...
        .def_readonly("graph_launches", &frame_fsm::FrameStatus::graph_launches)
        .def_readonly("host_boundaries", &frame_fsm::FrameStatus::host_boundaries)
        ...
        .def_readonly("hw_unique_blocks", &frame_fsm::FrameStatus::hw_unique_blocks)
        .def_readonly("required_dcd_pairs", &frame_fsm::FrameStatus::required_dcd_pairs)
        .def_readonly("required_ccd_pairs", &frame_fsm::FrameStatus::required_ccd_pairs)
        .def_readonly("required_triplets", &frame_fsm::FrameStatus::required_triplets)
        .def_readonly("required_unique_blocks", &frame_fsm::FrameStatus::required_unique_blocks)
        .def_readonly("hw_mas_clusters", &frame_fsm::FrameStatus::hw_mas_clusters)
        .def_readonly("required_mas_clusters", &frame_fsm::FrameStatus::required_mas_clusters)
        .def_readonly("root_graph_nodes", &frame_fsm::FrameStatus::root_graph_nodes)
        .def_readonly("root_d2h_nodes", &frame_fsm::FrameStatus::root_d2h_nodes)
        .def_readonly("terminal_graph_nodes", &frame_fsm::FrameStatus::terminal_graph_nodes)
        .def_readonly("terminal_d2h_nodes", &frame_fsm::FrameStatus::terminal_d2h_nodes)
        .def_readonly("final_alpha", &frame_fsm::FrameStatus::final_alpha)
        .def_readonly("final_energy", &frame_fsm::FrameStatus::final_energy)
        .def_readonly("max_movement", &frame_fsm::FrameStatus::max_movement)
    ...
    py::class_<SimEngine>(m, "SimEngine")
        ...
        .def("get_frame_status", &SimEngine::get_frame_status,
             "Read-only result/work/high-water packet for the latest frame.")
