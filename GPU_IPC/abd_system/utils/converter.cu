    ...
    Launch(block_dim, thread_dim)
        ...
        .apply(
                 ...
                 warp_id_in_unique_block.viewer().name("warp_id_in_block")] __device__() mutable
            {
                ...
                Matrix12x12 mat_block = origin_blocks(origin_block_index);
                ...
                typedef cub::WarpReduce<Matrix12x12> WarpReduce;
                typename WarpReduce::TempStorage temp_storage[thread_dim / 32];
                Matrix12x12 aggregate =
    ...
    muda::ParallelFor(256)
        ...
        .apply(unique_counts.size(),
                ...
                sort_index = sort_index.viewer().name("sort_index")] __device__(int i) mutable
               {
                   ...
                   // calculate the block
                   Matrix12x12 block = Matrix12x12::Zero();
